  ...
  return (
    <section id="about" className="py-24 sm:py-32 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-br from-violet-500/5 to-purple-600/5 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-gradient-to-br from-purple-500/5 to-violet-600/5 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          {highlights.map((item, i) => (
            ...
            >
              ...
              <div className="relative p-6 rounded-2xl border border-border bg-card overflow-hidden transition-all duration-500 group-hover:border-violet-500/30 group-hover:shadow-2xl group-hover:shadow-violet-500/5 group-hover:-translate-y-1">
                {/* Shimmer effect */}

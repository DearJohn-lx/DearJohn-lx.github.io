...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-24 sm:py-32 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[50rem] h-[50rem] bg-gradient-to-br from-violet-500/5 via-purple-600/3 to-violet-600/5 rounded-full blur-3xl animate-morph" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {contactItems.map((item, i) => (
            ...
            >
              ...
              <div className={`relative flex flex-col items-center p-8 rounded-2xl border ${item.borderColor} bg-card overflow-hidden transition-all duration-500 group-hover:border-violet-500/30 group-hover:shadow-2xl group-hover:shadow-violet-500/5 group-hover:-translate-y-2 text-center`}>
                {/* Top gradient bar */}
        ...
        >
          <Button
            size="lg"
            className="bg-gradient-to-r from-violet-500 via-purple-500 to-violet-500 hover:from-violet-400 hover:via-purple-400 hover:to-violet-400 text-black font-bold gap-2 rounded-full px-10 shadow-xl shadow-violet-500/20 hover:shadow-2xl hover:shadow-violet-500/30 transition-all duration-300 hover:scale-105 animate-gradient-shift bg-[length:200%_200%]"
            asChild
          >
